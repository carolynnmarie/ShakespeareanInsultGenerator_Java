...
public class Insults {
    ...
    private ArrayList<String> partOne;
    private ArrayList<String> partTwo;
    private ArrayList<String> partThree;
    private ArrayList<String> classics;

    public Insults(){
        this.partOne = new ArrayList<>(Arrays.asList("artless","bawdy","beslubbering","bootless", "churlish","cockered," +
                ...
                "spleeny","spongy","surly","tottering","unmuzzled","vain","venomed","villainous", "warped","wayward","weedy,","yeasty"));
        this.partTwo = new ArrayList<>(Arrays.asList("base-court","bat-fowling","beef-witted","beetle-headed","boil-brained",
        ...
        this.partThree = new ArrayList<>(Arrays.asList("apple-john","baggage","barnacle","blatter","boar-pig","bugbear","bum-bailey",
                ...
                "whey-face","wagtail"));
        this.classics = new ArrayList<>(Arrays.asList("A most notable coward, an infinite and endless liar, an hourly promise breaker, " +
    ...
    public ArrayList<String> getPartOne() {
        return partOne;
    }

    public ArrayList<String> getPartTwo() {
        return partTwo;
    }

    public ArrayList<String> getPartThree() {
        return partThree;
    }

    public ArrayList<String> getClassics() {
        return classics;
    }
}
